        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if(i==0)
                {
                    ...
                    cmd.CommandText = "insert into vendor (vendor_name,address,address_1,city,state,pincode,pan_number,gst_number,phone_number,vendor_type) Values ('"+textBox1.Text+"','"+textBox2.Text+"','"+textBox3.Text+"','"+textBox10.Text+"','"+textBox4.Text+"','"+textBox5.Text+"','"+textBox6.Text+"','"+textBox7.Text+"','"+textBox8.Text+"','FABRIC')";
                    cmd.ExecuteNonQuery();
