...
namespace Snap.fabric
{
    public partial class item_list : Form
    {
        ...
        public void datagride_add_data()
        {
            ...
            cmd3.CommandText = "select * from item where item_type='FABRIC'";
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            else if (comboBox1.Text == "Fabric Code")
            {
                ...
                MySqlCommand cmd3 = con.CreateCommand();
                cmd3.CommandType = CommandType.Text;
                cmd3.CommandText = "select * from item where item_type='FABRIC' and item_code like '%"+textBox1.Text+"%'";
                cmd3.ExecuteNonQuery();
                MySqlDataAdapter da = new MySqlDataAdapter(cmd3);
                DataTable dt = new DataTable();
                da.Fill(dt);
            ...
            else if (comboBox1.Text == "Categories")
            {
                ...
                MySqlCommand cmd3 = con.CreateCommand();
                cmd3.CommandType = CommandType.Text;
                cmd3.CommandText = "select * from item where item_type='FABRIC' and item_name like '%" + textBox1.Text + "%'";
                cmd3.ExecuteNonQuery();
                MySqlDataAdapter da = new MySqlDataAdapter(cmd3);
                DataTable dt = new DataTable();
                da.Fill(dt);
            ...
            else if (comboBox1.Text == "Sub Categories")
            {
                ...
                MySqlCommand cmd3 = con.CreateCommand();
                cmd3.CommandType = CommandType.Text;
                cmd3.CommandText = "select * from item where item_type='FABRIC' and item_catagory like '%" + textBox1.Text + "%'";
                cmd3.ExecuteNonQuery();
                MySqlDataAdapter da = new MySqlDataAdapter(cmd3);
                DataTable dt = new DataTable();
                da.Fill(dt);
