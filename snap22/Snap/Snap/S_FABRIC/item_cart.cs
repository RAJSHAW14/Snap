    ...
    public partial class item_cart : Form
    {
        ...
        public void fill_data()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                textBox11.Text = dr["purchase_rate"].ToString();
                textBox12.Text = dr["purchase_uom"].ToString();
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (i == 0)
                {
                    ...
                    cmd.CommandText = "insert into item (item_code,item_name,item_catagory,uom,gst,hsn,unit_price,last_purchase_price,inventory,color,width,item_type,purchase_uom,purchase_rate) Values ('" + textBox1.Text + "','" + comboBox1.Text + "','" + comboBox2.Text + "','" + textBox10.Text + "','" + textBox5.Text + "','" + textBox4.Text + "','" + textBox8.Text + "','" + textBox8.Text + "','0.00','" + textBox2.Text + "','" + textBox3.Text + "','S-FABRIC','"+textBox12.Text+"','"+textBox11.Text+"')";
                    cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                MySqlCommand cmd = con.CreateCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "update item set item_name='" + comboBox1.Text + "',item_catagory='" + comboBox2.Text + "',uom='" + textBox10.Text + "',gst='" + textBox5.Text + "',hsn='" + textBox4.Text + "',unit_price='" + textBox8.Text + "',color='" + textBox2.Text + "',width='" + textBox3.Text + "',purchase_rate='" + textBox11.Text + "',purchase_uom='"+textBox12.Text+"' where ID='" + textBox9.Text + "'";
                cmd.ExecuteNonQuery();
