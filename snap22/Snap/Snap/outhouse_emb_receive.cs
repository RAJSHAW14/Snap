...
namespace Snap
{
    public partial class outhouse_emb_receive : Form
    {
        static string constring = ConfigurationManager.ConnectionStrings["$safeprojectname$.Properties.Settings.erpConnectionString"].ConnectionString;
        MySqlConnection con = new MySqlConnection(constring);
        public outhouse_emb_receive()
        {
            InitializeComponent();
        }

        private void outhouse_emb_receive_Load(object sender, EventArgs e)
        {
        ...
        {
            MySqlCommand cmd = new MySqlCommand("select order_number from emb_tracker where order_number like '%" + textBox22.Text + "%' and order_type='OUT-HOUSE'", con);
        ...
        public void fetch_order_details()
        {
            ...
            cmd.CommandText = "select * from emb_tracker where order_number='"+textBox22.Text+ "' and order_type='OUT-HOUSE'";
            cmd.ExecuteNonQuery();
