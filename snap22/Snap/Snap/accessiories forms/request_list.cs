...
namespace Snap.accessiories_forms
{
    public partial class request_list : Form
    {
        ...
        {
            MySqlDataAdapter da = new MySqlDataAdapter("select * from acc_request where pending_qty>0", con);
        ...
        {
            MySqlDataAdapter da = new MySqlDataAdapter("select * from acc_request where req_number='" + textBox1.Text + "'", con);
            DataTable dt = new DataTable();
            da.Fill(dt);
            foreach (DataRow dr in dt.Rows)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    cmd.CommandText = "delete from acc_request where id='" + id_value + "'";
                    cmd.ExecuteNonQuery();
