...
{
    public partial class acc_add_stock : Form
    {
        static string constring = ConfigurationManager.ConnectionStrings["$safeprojectname$.Properties.Settings.erpConnectionString"].ConnectionString;
        MySqlConnection con = new MySqlConnection(constring);
        public acc_add_stock()
        {
            InitializeComponent();
        }

        private void acc_add_stock_Load(object sender, EventArgs e)
        {
        ...
        private void textBox1_Leave(object sender, EventArgs e)
        {
            ...
            {
                int i = 0;
                MySqlDataAdapter da = new MySqlDataAdapter("select * from item where item_code='" + textBox1.Text + "' and item_type='ACC'", con);
