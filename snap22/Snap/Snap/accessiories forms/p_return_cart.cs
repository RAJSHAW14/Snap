...
{
    public partial class p_return_cart : Form
    {
        static string constring = ConfigurationManager.ConnectionStrings["$safeprojectname$.Properties.Settings.erpConnectionString"].ConnectionString;
        MySqlConnection con = new MySqlConnection(constring);
        public p_return_cart()
        {
            InitializeComponent();
        }

        private void p_return_cart_Load(object sender, EventArgs e)
        {
        ...
        {
            MySqlDataAdapter da = new MySqlDataAdapter("select * from acc_grn where transaction_type='P-RETURN' AND number='" + textBox2.Text + "'", con);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MySqlDataAdapter da = new MySqlDataAdapter("select MAX(number) as grn_number from acc_transactions where transaction_type='P-RETURN'", con);
                DataTable dt = new DataTable();
                da.Fill(dt);
                foreach (DataRow dr in dt.Rows)
                {
                ...
                for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                {
                    ...
                    cmd.CommandText = "insert into acc_transactions (transaction_type,number,item_code,rate,uom,qty,ex_tax_mt,reff_po_number,bill_number,bill_date,vendor,gst_amt,inc_tax_amt,date) Values ('P-RETURN','" + textBox2.Text + "','" + dataGridView1.Rows[i].Cells[0].Value + "','" + dataGridView1.Rows[i].Cells[4].Value + "','" + dataGridView1.Rows[i].Cells[3].Value + "','" + dataGridView1.Rows[i].Cells[5].Value + "','" + dataGridView1.Rows[i].Cells[6].Value + "','" + textBox8.Text + "','" + textBox7.Text + "','" + maskedTextBox3.Text + "','" + textBox1.Text + "','" + dataGridView1.Rows[i].Cells[11].Value + "','" + dataGridView1.Rows[i].Cells[9].Value + "','" + maskedTextBox1.Text + "')";
                    cmd.ExecuteNonQuery();
                }
                ...
                MessageBox.Show("PURCHASE RETURN Saved Your RETURN Number is " + textBox2.Text);
                this.Close();
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd1.CommandText = "delete from acc_transactions where number='" + textBox2.Text + "' and transaction_type='P-RETURN'";
                ...
                MessageBox.Show("Purchase Return Updated");
                this.Close();
            }
        }
    }
